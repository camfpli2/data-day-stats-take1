...
function whistlePricesPage() {
    ...
    controls.push(new control(295,5,150,60,"Boxplot",true,butColor));
    controls.push(new control(415,5,100,60,"Mod. Boxplot",true,butColor));
    drawControls();
...
function axes(){
  ...
  for(var g=150;g<=950;g+=(800/numBars)){  //labelling major grid values which start and end each histogram bin
    ...
    noStroke();
    if(xPixelTracker>120||xPixelTracker===0){
